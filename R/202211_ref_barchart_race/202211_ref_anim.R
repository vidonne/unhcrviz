...
# Load data
df_ref <- readr::read_csv(here::here("R", "202211_ref_barchart_race", "ref_oip_2002_2022.csv"))
...
save_animation(animation = anim_coo, 
               file = here::here("plots", "202211_ref_coo_race.gif"))

save_animation(animation = anim_coa, 
               file = here::here("plots", "202211_ref_coa_race.gif"))
