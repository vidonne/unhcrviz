...
# Load data
idp_raw <- read_csv(here::here("R", "202111_idp_barchart_race", "idp_2010_2020.csv"))

# Create rank by year for animation
idp_rank <- idp_raw |>
  group_by(year) |>
...
# Save animation
anim_save(here::here("plots", "202111_idp_barchart_race.gif"))
